...
#elif NET_SERVE == 1
// 物联网开发平台（阿里云支持）
#define ServerIP "iot-06z00bhlj16tvj8.mqtt.iothub.aliyuncs.com" // 服务器IP地址
...
// 设备信息
/**
#define PROID "h9sjcgwbTUs"															 // 产品ID
#define DEVID "smartdevice" // 设备ID
#define AUTH_INFO "09ed23543362cb392239c74970ee6e0e"						 // 鉴权信息
**/

#define PROID "k11q5RB034G"															 // 产品ID
#define DEVID "smartdevice" // 设备ID
#define AUTH_INFO "f449d680827e727ffdaf5cd285b83163"						 // 鉴权信息

// MQTT主题 /broadcast/
#define S_TOPIC_NAME "/broadcast/k11q5RB034G/test1" // 需要订阅的主题 
#define P_TOPIC_NAME "/broadcast/k11q5RB034G/test2" // 需要发布的主题

#define P_TOPIC_CMD "/sys/k11q5RB034G/smartdevice/thing/event/property/post"
